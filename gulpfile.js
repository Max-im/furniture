...
gulp.task('css-libs', function(){
	return gulp.src([
		...
		'src/libs/owlCarousel/owl-carousel/owl.transitions.css' // owlCarousel transition
...
gulp.task('watch', ['browser-sync', 'sass', 'libs-js', 'plugins-js', 'babel', 'sprite' ], function() {
...
gulp.task('build', ['clean', 'img', 'sass', 'libs-js', 'plugins-js'], function() {
